        ...
        <div class="col-span-12 bg-gray-100">
          <form class="p-16" id="new-todo-form" @submit.prevent="addTodo">
            <div class="">
              ...
              <div class="flex">
                <input class="w-full py-2 px-4 border-gray-200 border focus:outline-none" type="text" name="content" id="content" placeholder="e.g. make a ToDo" v-model="input_content" />
        ...
        <div class="col-span-12 bg-gray-100">
          <div class="mx-auto flex flex-col gap-1" id="todo-list">
            <div class="bg-gray-500 w-full flex text-white text-center items-center" v-for="todo in todos" :key="todo.id" :class="{ completed: todo.done }">
              <div @click="checkTodo(todo.id)" class="todo-content flex-grow cursor-pointer text-xl">
                {{ todo.content }}
              </div>
...
onMounted(() => {
  ...
  Object.assign( todos , JSON.parse(localStorage.getItem("todos")));
});
</script>
